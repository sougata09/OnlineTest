...
<html>
    ...
    <center>
        <div class="main">
            <div class="bar">
                <div style="float: left; width: 580px; margin: 8px 0px 5px 200px; font-size: 20px;"><marquee behavior="alternate"  direction="left" style="text-align:center;">GCELT Online Test Exam</marquee></div>
                <%
            ...
            <div class="header" style="background-image: url(resources/images/h.jpg);">
